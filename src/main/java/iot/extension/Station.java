...
public class Station extends Timed {
	...
	/**
	 * It contains the all important data of the station.
	 * A station osszes fontos adatat tartalmazza.
	 */
	private Stationdata sd;
	
	/**
	 *  Local repository where the data are stored.
	 *  Lokalis repository az adattarolashoz.
	 */
	private Repository repo;
	
	/**
	 *  Reference for the repository which will receive the data.
	 *  Referencia a cel repository-ra, ami fogadja az adatot.
	 */
	private Repository torepo;
	
	/**
	 *  Size of the local repository.
	 *  A lokalis repository merete.
	 */
	private long reposize;
	
	/**
	 *  It contains the time when the station start to work.
	 *  Tartalmazza a szimulalt idot,amikor a station elkezd mukodni.
	 */
	private long time;
	
	/**
	 *  Necessary to organize the station's repository and the cloud repository in the same network.
	 *  Szukseges a lokalis es a cel repository kozos halozatba szervezeshez.
	 */
	private HashMap<String, Integer> lmap;
	
	/**
	 * ID of the the common network.
	 * A kozos halozat azonositoja.
	 */
	private int lat;
	
	/**
	 * Helper variable for the shared nothing cloud.
	 * Segedvaltozo a shared nothing felhohoz.
	 */
	private int i;
	
	/**
	 *  Reference for a virtual machine which is used when we send data directly to repository of a physical machine.
	 *  Referencia a virtualis gepre ha kozvetlenul kuldunk adotot egy fizikai gep repository-nak
	 */
	private VirtualMachine vm;
	
	/**
	 *  Reference for a phisical machine which is used when we send data directly to repository of a physical machine.
	 *  Referencia a fizikai gepre ha kozvetlenul kuldunk adotot egy fizikai gep repository-nak
	 */
	private PhysicalMachine pm;
	
	/**
	 * True if the station is working,otherwise false.
	 * Erteke igaz,ha mukodik a station, egyebkent hamis
	 */
	private boolean isWorking;
	
	/**
	 *  If true the Metering() method will be randomly delayed.
	 *  Ha igaz,akkor a Metering() metodus random kesleltetve lesz.
	 */
	private boolean randommetering;
	
	/**
	 * Reference for an IaaS Service which is the same network with this station.
	 * Referencia arra a felhore, amellyel a station kozos halozatban van.
	 */
	public Cloud cloud;
	
	/**
	 * It's an ID which is important when we use more clouds.
	 * A tobb felhos szimulacioknal ez alapjan kerulhet azonositasra a celfelho.
	 */
	int cloudnumber;
	
	/**
	 *  Important when we check if all data has arrived.
	 *  Fontos,amikor ellenorizzuk, hogy az osszes adat el lett-e kuldve.
	 */
	private int messagecount;
	
	/**
	 *  This ArrayList can contains all stations which we use during the simulation.
	 *  A szimulacio soran ebben az ArrayList-ben tudjuk eltarolni az osszes station-unket.
	 */
	private static ArrayList<Station> stations = new ArrayList<Station>();
	
	/**
	 * It's an Array which is important when we use more clouds to check the sent data.
	 * A tobb felhos szimulacioknal ez alapjan kerulhet ellenorzesre az adatmennyisegek.
	 */
	private static long[] stationvalue; 

	/**
	 *  It cointains the all size of data which was generated by this station.
	 *  Az osszes generalt adat meretet tarolja, amit ez a station generalt.
	 */
	public long generatedfilesize;
	
	/**
	 *  It cointains the all size of data which was generated by stations.
	 *  Az osszes generalt adat meretet tarolja, amit az osszes station generalt.
	 */
	public static long allstationsize=0;
	
	/**
	 *  This getter method give the main data of the station.
	 *  A station fobb adatait tartalmazza.
	 */
	...
	/**
	 * Static getter method to reach all stations from everywhere.
	 * Statikus getter metodus, hogy az osszes station elerheto legyen.
	 */
	...
	/**
	 * Getter method for the Array which contains  ID of the cloud.
	 * Getter a felhoazonositokat tartalmazo tombhoz.
	 */
	...
	/**
	 * Setter method for the Array which contains  ID of the cloud.
	 * Setter a felhoazonositokat tartalmazo tombhoz.
	 */
	...
	/**
	 * Getter method for the number of messages which was generated by the station.
	 * Getter a station altal aloallitott uzenetek szamahoz.
	 */
	...
	/**
	 * Getter method for the  ID of cloud which belongs to this station.
	 * Getter metodus a felho azonositohoz, amelyhez ez a station tartozik.
	 */
	...
	/**
	 * Setter method for the  ID of cloud which belongs to this station.
	 * Setter metodus a felho azonositohoz, amelyhez ez a station tartozik.
	 */
	...
	/**
	 * Getter method for the name of station.
	 * Getter metodus a station nevehez.
	 */
	...
	/**
	 * Setter method tfor an IaaS Service which is the same network with this station.
	 * Setter metodus a felhohoz, amivel a station kozos halozatban van.
	 */
	...
	/**
	 * Getter method for the  local repository of this station.
	 * Getter metodus a a station lokalis repository-jahoz.
	 */
	...
	/**
	 * Setter method for the  local repository of this station.
	 * Setter metodus a a station lokalis repository-jahoz.
	 */
	...
	/**
	 *  Setter method is useful for the pricing and checking methods.
	 *  Setter metodus hasznos a koltsegszamitasnal es az ellenorzo metodusoknal.
	 */
	...
	/**
	 * Constructor creates the local repository based on the parameters and organize the local and the cloud repository to the same network.
	 * A konstruktor letrehozza a lokalis repository-t majd kozos halozatba szervezi a felho cep repository-javal. 
	 * @param maxinbw in-bandwidth of the local repository - bejovo savszelesseg a lokalis repository-nak
	 * @param maxoutbw out-bandwidth of the local repository - kimeno savszelesseg a lokalis repository-nak
	 * @param diskbw disk-bandwidth of the local repository - disk savszelesseg a lokalis repository-nak
	 * @param reposize the size of the local repository - a lokalis repository merete
	 * @param sd the main data of the station - a station fobb tulajdonsagai
	 * @param randommetering if true the Metering() method will be delayed - ha true, akkor a Metering() hivas keslelteve lesz
	 */
	...
	/**
	 * This event will delete the StorageObject from the local repository when it arrived.
	 * Ha sikeresen megerkezett a celrepository-ba a StorageObject, akkor a lokalis tarolobol torli azt.
	 */
	private class StorObjEvent implements ConsumptionEvent {
		
		/**
		 * It contains the ID of the event.
		 * Az esemeny azonositoja.
		 */
		private String so;

		/**
		 * Constructor give the local variable to the value of the parameter.
		 * A konstruktor parameterben kapja az esemeny azonositojat.
		 * @param soid the ID of the event
		 */
		...
		/**
		 * It will be called when the StorageObject arrived, then it will be removed from the local repository. 
		 * Ha a StorageObject megerkezett, akkor a lokalis repository-bol torlesre kerul.
		 */
		@Override
